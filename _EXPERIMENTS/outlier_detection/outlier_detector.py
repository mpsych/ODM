    ...
    def _detect_outliers(data_x,
        ...
        if pyod_algorithm == 'ECOD':
            ...
            if 'CBLOF' in kwargs:
                ...
                clf = CBLOF(n_clusters=n_clusters,
                            contamination=contamination,
            ...
            if 'Sampling' in kwargs:
                ...
                clf = Sampling(contamination=contamination,
            ...
            if 'GMM' in kwargs:
                ...
                warm_start = kwargs.get('warm_start',
                                        False)  # warm start was None not False
                random_state = kwargs.get('random_state', None)
            ...
            if 'PCA' in kwargs:
                ...
                random_state = kwargs.get('random_state', None)
                n_selected_components = kwargs.get('n_selected_components',
                                                   None)
            ...
            if 'LMDD' in kwargs:
                ...
                random_state = kwargs.get('random_state', None)
                clf = LMDD(contamination=contamination,
                           n_iter=n_iter,
            ...
            if 'INNE' in kwargs:
                ...
                contamination = kwargs.get('contamination', 0.1)
                random_state = kwargs.get('random_state', None)
                clf = INNE(n_estimators=n_estimators,
                           max_samples=max_samples,
                           contamination=contamination,
                           random_state=random_state)
            ...
            if 'FB' in kwargs:
                ...
                check_detector = kwargs.get('check_detector',
                                            True)  # was False when should be True
                check_estimator = kwargs.get('check_estimator', False)
                n_jobs = kwargs.get('n_jobs', 1)
                ...
                clf = FeatureBagging(base_estimator=base_estimator,
            ...
            if 'SUOD' in kwargs:
                ...
                cost_forecast_loc_pred = kwargs.get('cost_forecast_loc_pred',
                                                    None)
                cost_forecast_loc_fit = kwargs.get('cost_forecast_loc_fit',
                                                   None)
            ...
            if 'SOGAAL' in kwargs:
                ...
                contamination = kwargs.get('contamination', 0.1)
                clf = SO_GAAL(stop_epochs=stop_epochs,
                              lr_d=lr_d,
                              lr_g=lr_g,
                              decay=decay,
                              momentum=momentum,
            ...
            if 'MOGAAL' in kwargs:
                ...
                momentum = kwargs.get('momentum', 0.9)
                contamination = kwargs.get('contamination', 0.1)
                clf = MO_GAAL(stop_epochs=stop_epochs,
                              lr_d=lr_d,
                              lr_g=lr_g,
                              decay=decay,
                              momentum=momentum,
            ...
            if 'AnoGAN' in kwargs:
                ...
                clf = AnoGAN(activation_hidden=activation_hidden,
                             dropout_rate=dropout_rate,
